...
<body style="background-color: #e9ecef;">
    ...
    <div class="preheader"
        ...
        Hey {{ $user->email }}, Thank you for signing up
    </div>
    <!-- end preheader -->
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td align="center" valign="top" style="padding: 36px 24px;">
                            <img src="https://yogabayuap.com/wp-content/uploads/2022/12/cropped-cropped-cropped-Untitled-1-removebg-preview-1-e1671589794331.png"
            ...
            <td align="center" bgcolor="#e9ecef">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf">
                            <p style="margin: 0;"><b>E-email valid for 30 minutes</b></p>
                        </td>
                    </tr>
