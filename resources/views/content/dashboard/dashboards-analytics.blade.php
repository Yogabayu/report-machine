        ...
        <div class="col-lg-8 mb-4 order-0">
            <div class="card">
                <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            <h5 class="card-title text-primary">Congratulations @if ($profile && $profile->nama)
                                    {{ $profile->nama }}
                                @else
                                    {{ $user->email }}
                                @endif! 🎉</h5>
                            <p class="mb-4">Selamat <span class="fw-bold">Datang</span></p>
                ...
                <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between">
                                <div class="avatar flex-shrink-0">
                                    <img src="{{ asset('assets/img/icons/unicons/building.svg') }}" alt="building"
                                        class="rounded">
                                </div>
                                <div class="dropdown">
                ...
                <div class="col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="fw-semibold d-block mb-1">Mesin</span>
                            <h3 class="card-title mb-2">{{ $totalMachine }}</h3>
                        </div>
                    </div>
                </div>
                <!-- </div>
